        ...
        <div className="container">
            ...
            <div className="main-div">
                ...
                <form>
                    ...
                    <div className="row">
                        <div className="form-group col-md-5">
                            {empDetails.employeeStatus != "CONFIRMED" && <button onClick={confirmStatus} className="btn btn-success">Confirm employee</button>}
                            {empDetails.employeeStatus == "CONFIRMED" && <button onClick={revokeStatus} className="btn btn-success">Revoke employee</button>}
